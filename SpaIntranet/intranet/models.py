...
class Cliente(models.Model):
    ...
    telefono = models.BigIntegerField()  # INT en MySQL puede ser muy grande para models.IntegerField()

class FichaClinica(models.Model):
    cliente = models.ForeignKey(Cliente, on_delete=models.CASCADE)
    nombre = models.CharField(max_length=60)
    fecha_cita = models.DateField()
    telefono = models.BigIntegerField()  # Mismo caso que arriba
    ...
    peso = models.FloatField()  # No se especifica precisión y escala ya que sera quitado de SQL
    talla = models.FloatField()  # No se especifica precisión y escala
    imc = models.FloatField(null=True, blank=True)  # No se especifica precisión y escala
...
class Cita(models.Model):
    ...
    asignado_a = models.CharField(max_length=20, blank=True)
    STATUS_CHOICES = [
